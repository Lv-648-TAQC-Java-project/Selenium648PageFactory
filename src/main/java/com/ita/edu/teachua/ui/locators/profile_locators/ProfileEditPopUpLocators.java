...
public class ProfileEditPopUpLocators {
    ...
    public static final String SAVE_CHANGE_BUTTON_XPATH = "//button[@class='ant-btn submit-button']/span";
    ...
    public static final String INPUT_ERROR_MESSAGE_XPATH = "//*[@id='edit_currentPassword']/following::div[@class='ant-form-item-explain ant-form-item-explain-error']/div]";
